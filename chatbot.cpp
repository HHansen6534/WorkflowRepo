...
int main() {
    ...
    string name;
    cin >> name;
    cout << "Hello " << name << "! How can I help you today? Please select from the following options: (1, 2, 3, 4)" << endl;
    ...
    if (num == '1') {
        cout << "The weather should be nice and sunny out today! Since it is spring and gets cooler in the evening, I woul dbring a small jacket!" << endl;
    }
    if (num == '2') {
        ...
        cout << "You're final total with tax included is $" << finaltotal << " ! " << endl;
    }
    if (num == '3') {
        ...
        if (response == "M") {
            ...
            int product;
            product = num1 * num2;
            cout << "You're number when multiplied equals: " << product << " !" << endl;
        }
        if (response == "A") {
            cout << "What is your first number?" << endl;
            int number1;
